...
int main(int argc, char *argv[]) 
{
  ...
  argparse_describe(&argparse, "\nExtract text from barcode or QR code in pdf.", NULL);
  ...
  char* error = NULL;
  char* text = NULL;
  int ret = goo_pdf_scan(pdf_path, page_number, (int)x1, (int)y1, (int)(x2 - x1), (int)(y2 - y1), &text, &error);
